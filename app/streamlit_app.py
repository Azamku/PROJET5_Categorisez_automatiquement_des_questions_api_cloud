...
if st.button("Prédire"):
    response = requests.post("https://myfastapiappstack-hnfjcmgehydeb7hm.westeurope-01.azurewebsites.net/", json={"text": input_text}) #adresse de notre app déployée sur azure
    print(response)
